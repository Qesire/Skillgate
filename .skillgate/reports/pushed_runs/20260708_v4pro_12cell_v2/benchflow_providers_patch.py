...
PROVIDERS: dict[str, ProviderConfig] = {
    ...
    "ustc-deepseek": ProviderConfig(
        name="ustc-deepseek",
        base_url="{base_url}",
        api_protocol="openai-completions",
        auth_type="api_key",
        auth_env="BENCHFLOW_PROVIDER_API_KEY",
        url_params={"base_url": "BENCHFLOW_PROVIDER_BASE_URL"},
        url_param_defaults={"base_url": "https://api.llm.ustc.edu.cn/v1"},
        model_prefixes=["ustc-deepseek"],
    ),
