...
BUILTIN_CONTRACTS: dict[str, dict[str, Any]] = {
    "bug_fix": {
        ...
        "execution_constraints": [
            _slot("no_test_modification", "Do not modify test expectations unless explicitly authorized",
                  "safe_assumption", support="recommended"),
            _slot("no_public_api_change", "Do not change public API unless explicitly authorized",
                  "safe_assumption", support="recommended"),
            _slot("minimal_source_changes", "Prefer minimal source changes over broad refactors",
                  "safe_assumption", support="recommended"),
        ],
        "forbidden_actions": [],
        "stop_conditions": [],
    ...
    "refactor": {
        ...
        "execution_constraints": [
            _slot("preserve_behavior", "Preserve public behavior",
                  "safe_assumption", support="recommended"),
            _slot("no_public_api_change", "Do not change public API without authorization",
                  "safe_assumption", support="recommended"),
            _slot("localized_changes", "Keep changes localized",
                  "safe_assumption", support="recommended"),
        ],
        "forbidden_actions": [],
        "stop_conditions": [],
